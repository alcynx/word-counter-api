...
/* package word-counter-0.1.0.0 */
#ifndef VERSION_word_counter
#define VERSION_word_counter "0.1.0.0"
#endif /* VERSION_word_counter */
#ifndef MIN_VERSION_word_counter
#define MIN_VERSION_word_counter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_word_counter */
...
#define CURRENT_COMPONENT_ID "word-counter-0.1.0.0-4ZDxW1c2BqTFbop6YsDUSU-word-counter"
